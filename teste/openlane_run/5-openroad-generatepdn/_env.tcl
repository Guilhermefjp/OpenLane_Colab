...
set ::env(CURRENT_ODB) /content/openlane_run/4-openroad-ioplacement/spm.odb
set ::env(SAVE_ODB) /content/openlane_run/5-openroad-generatepdn/spm.odb
set ::env(SAVE_DEF) /content/openlane_run/5-openroad-generatepdn/spm.def
set ::env(SAVE_SDC) /content/openlane_run/5-openroad-generatepdn/spm.sdc
set ::env(SAVE_NETLIST) /content/openlane_run/5-openroad-generatepdn/spm.nl.v
set ::env(SAVE_POWERED_NETLIST) /content/openlane_run/5-openroad-generatepdn/spm.pnl.v
