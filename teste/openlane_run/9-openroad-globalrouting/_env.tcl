...
set ::env(CURRENT_ODB) /content/openlane_run/8-openroad-cts/spm.odb
set ::env(SAVE_ODB) /content/openlane_run/9-openroad-globalrouting/spm.odb
set ::env(SAVE_DEF) /content/openlane_run/9-openroad-globalrouting/spm.def
